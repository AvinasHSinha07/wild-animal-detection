...
//   // Dummy data for post details (replace with real data or fetch from API)
//   const post = {
//     id: postId,
//     text: 'This is the post detail text',
//     likes: 10,
//     dislikes: 3,
...
//         </TouchableOpacity>
//         <Text style={styles.likesText}>{post.dislikes}</Text>
//       </View>
...
//     try {
//       const commentsQuery = query(collection(db, 'comments'), where('postId', '==', postId), orderBy('timestamp', 'desc'));
...
//       const commentsQuery = query(commentsRef, where('postId', '==', postId), orderBy('timestamp', 'desc'));
//       const unsubscribe = onSnapshot(commentsQuery, (snapshot) => {
//         const fetchedComments = snapshot.docs.map((doc) => ({
//           id: doc.id,
//           ...doc.data(),
